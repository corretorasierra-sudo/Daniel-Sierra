...
import { calcularProgressoMeta, calcularProjecaoFechamento } from "@/lib/metricas";
...
export default async function CoordenadorHomePage() {
  ...
  const [vendedores, vendasNoPeriodo, vendasRecentes, rankingLateral] = await Promise.all([
